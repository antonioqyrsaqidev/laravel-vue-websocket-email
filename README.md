...
-front-end : Vue.js(SPA: Single Page Application)
-back-end: Laravel
...
- Websocket with pusher and laravel-io
...
3.  Get an .env file from the .env.example file
    (DB configuration, MailServer configuration)
    `cp .env.example .env`
    `gedit .env`
...
1.  Sign up for free at mailtrap.io to test verifying email confirmation.
...
E-mail : antonioqyrsaqi_dev@outlook.com
